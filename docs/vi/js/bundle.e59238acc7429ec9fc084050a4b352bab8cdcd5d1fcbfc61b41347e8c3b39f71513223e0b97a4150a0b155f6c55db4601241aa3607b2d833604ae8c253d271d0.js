...
const baseURL = 'https://thaoprovt1.github.io/ThaoBlog/';
...
const quickLinks = 'Kết quả';
const searchResultsLabel = 'Kết quả tìm kiếm';
const shortSearchQuery = 'Query is too short'
const typeToSearch = 'Nhập để tìm';
const noMatchesFound = 'Không có kết quả nào cả';
